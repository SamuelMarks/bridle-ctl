...
import { AppTableComponent, AppTableColumnDirective } from './app-table.component';
...
describe('AppTableComponent', () => {
  ...
  it('should render the title', () => {
    const titleEl = fixture.debugElement.query(By.css('.Box-title')).nativeElement;
  ...
  it('should fallback to item in trackByFn if id is missing', () => {
    const tableComponent = fixture.debugElement.query(By.directive(AppTableComponent)).componentInstance;
